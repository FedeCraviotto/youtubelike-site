          ...
          <div className="details">
            <div className="info">
              ...
              <div className="channel">
                ...
                <span>{(dummyVideo.suscribers).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} suscriptores</span>
              </div>
              <button>
            ...
            <div className="buttons">
              <div className="thumbs">
                <button className=""><ThumbUpOutlinedIcon /> {(dummyVideo.likes).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</button>
                <button><ThumbDownOutlinedIcon /></button>
              </div>
              <button><ReplyOutlinedIcon /> Compartir</button>
              <button><GetAppOutlinedIcon /> Descargar</button>
              <button className='three-dots'><MoreHorizOutlinedIcon /></button>
            </div>
          </div>
        </div>
      </div>
